...
def classify(query, hierarchical_data, vector_search_examples):
    if Config.USE_EXAMPLES:
        ...
        **Note:** Αν επέλεξες "Καμία" και έχεις παραδείγμα σχετικό σημασιολογικά με το ερώτημα του χρήστη, θεώρισε το σωστό και δώσε σαν αποτέλεσμα την κατηγοριοποιηση του παραδείγματος. **SUPERCATEGORY**, **CATEGORY**, **SUBCATEGORY**, αλλιώς "Καμία".
